...
function llenarTablaAulas(jsondatos,jsondetalles){
	...
	$("#nomaula").html("AULA: "+jsondetalles[0]["aula"]);
	$("#caracteristica").html("Capacidad "+jsondetalles[0]['capacidad']+" sillas <br> Con Pizarra "+jsondetalles[0]["pizarra"]+" y "+taburete+" tiene taburete");
